...
## StoryLine 1: "Daimonic Knight"


### Daimon - origin and meaning
_`Daimon` is the english translation of an Ancient Greek word `δαίμων`, which meant "god", or  "godlike", or "power" and "fate".   The more familiar word "Daemon", is the Latin translation of the Greek one.  A `Daimon` was originally referred to as a lesser deity or guiding spirit, such as the powers of ancient Greek religion and mythology and of later Hellenistic religion and philosophy._

_The word also has origins from the Proto-Indo-European meaning "provider, divider (of fortunes or destinies)," from the root da- "to divide". `Daimons` were possibly believed to be the souls of men and women of the golden age acting as tutelary deities, according to entry `δαίμων` at Liddell & Scott._

_In summary, a `daimon` was believed to be a powerful or semi-divine entity, that acted as a protector, guardian, patron, teacher, and ruler in the ancient world._

_Additionally, For reference, BCE is the acronym for Before Common Era. The Common Era, described with the acronym CE, begins with year 1 in the Gregorian calendar and is also known as the Western or Christian calendar._
...
### Daimonic Cultures & Influence throughout History
...
??? info "Greek and Roman civilization"
